...
<!-- =====================================================
         ******* Naeem order tracking Part Start *******
========================================================-->
                ...
                <div class="all-products-div">
                    ...
                    <div class="single-order-list row">
                        <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 d-flex">
                            <div class="product-img">
                                <img src="{{ asset('frontend/assets/image/Helly-Hansen-Verglas-Down-Jacket-PNG (1).png')}}" alt="product-img">
                            </div>
                        ...
                        <div class="other-quantity col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 d-flex align-items-center justify-content-between">
                            <div class="price">
                                <span>$255</span>
                            </div>
                            <div class="qty">
                    ...
                    <div class="single-order-list row">
                        <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 d-flex">
                            ...
                            <div class="product-name d-flex flex-column">
                                <h4>New Aluminum Magnesium Sunglasses Aluminum collection 2k21</h4>
                                <div class="dasktop">
                                    <p><b>Size:</b> <span>Medium</span></p>
                                    <p><b>Color:</b> <span>Gray</span></p>
                                </div>
