                ...
                <div class="card card-pages shadow-none">
                    ...
                    <div class="card-body">
                        <div class="text-center m-t-0 m-b-15">
                                <!-- <a href="index.html" class="logo logo-admin"><img src="{{ asset('backend/assets/images/logo-dark.png')}}" alt="" height="24"></a> -->
                               <h4>Admin</h4>
                        </div>
                        <h5 class="font-18 text-center">Sign in to continue to Admin.</h5>
                        ...
                        @csrf
                            <div class="form-group">
                                <div class="col-12">
                                    <label>Email</label>
                                    <input class="form-control @error('email') is-invalid @enderror" type="email" placeholder="Email Address" name="email" value="{{ old('email') }}" required>
                                    @error('email')
