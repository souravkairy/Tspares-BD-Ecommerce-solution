                                 ...
                                 <div class="col-lg-8">
                                     <form action="{{ url('update-section-setting') }}" method="POST"
                                         ...
                                         <div class="form-group row">
                                             <div class="col-sm-12">
                                                 <input type="text" id="text" class="form-control" name="sec1Text" placeholder="Heading" value="{{$sectionSetting->sec1Text}}">
                                             </div>
                                         </div>
                                         <div class="form-group row">
                                             <div class="col-sm-12">
                                                 <select name="sec1catName" id="" class="form-control" value="{{$sectionSetting->sec1catName}}">
                                         ...
                                         <div class="form-group row">
                                             <div class="col-sm-12">
                                                 <input type="text" id="file" class="form-control" name="sec1BtnLink" placeholder="button Link" value="{{$sectionSetting->sec1BtnLink}}">
                                             </div>
                                         </div>
                             ...
                             <div class="row mt-2">
                                 <div class="col-lg-8">
                                     <form action="{{ url('update-section-setting') }}" method="POST"
                                         ...
                                         <div class="form-group row">
                                             <div class="col-sm-12">
                                                 <input type="file" id="file" class="form-control" name="sec2Image" value="{{$sectionSetting->sec2Image}}">
                                             </div>
                                         </div>
                                         <div class="form-group row">
                                             <div class="col-sm-12">
                             ...
                             <div class="row mt-2">
                                 <div class="col-lg-8">
                                     <form action="{{ url('update-section-setting') }}" method="POST"
                                         ...
                                         <div class="form-group row">
                                             <div class="col-sm-12">
                                                 <input type="file" id="file" class="form-control" name="sec3Image" value="{{$sectionSetting->sec3Image}}">
                                             </div>
                                         </div>
                                         <div class="form-group row">
                                             <div class="col-sm-12">
                                                 <input type="text" id="file" class="form-control" name="sec3BtnLink" placeholder="Button Link" value="{{$sectionSetting->sec3BtnLink}}">
                                             </div>
                                         </div>
                                         <div class="text-center">
                                             <button type="submit"
                            ...
                            <div class="row mt-2">
                                <div class="col-lg-8">
                                    <form action="{{ url('update-section-setting') }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <input type="file" id="file" class="form-control" name="sec4Image" value="{{$sectionSetting->sec4Image}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                            ...
                            <div class="row mt-2">
                                <div class="col-lg-8">
                                    <form action="{{ url('update-section-setting') }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <input type="file" id="file" class="form-control" name="sec5Image"  value="{{$sectionSetting->sec5Image}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-12">
